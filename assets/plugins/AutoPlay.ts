...
class AutoPlay {
    ...
    run(player: mediaPlayer) {
        ...
        if (!player.media.muted) { //si no esta en muted lo pondremos muted
            ...
            player.media.muted = true; //como es un set no lo llamamos como una funcion simplemente le pasmos el valor
       //usamso el media.muted porque el player desaparecio pero ahora podemos usar las fucniones de la clase de mediaPlayer porque estamos haeindo uso del this
        }
